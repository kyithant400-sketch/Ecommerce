...
$(document).ready(function() {
    ...
    var switchElements = [
        '.js-switch-setting-first', '.js-switch-setting-second', 
        '.js-switch-setting-third', '.js-switch-setting-fourth', 
        '.js-switch-setting-fifth', '.js-switch-setting-sixth', 
        '.js-switch-setting-seventh', '.js-switch-setting-eightth'
    ];

    switchElements.forEach(function(selector) {
        var elem = document.querySelector(selector);
        // အရေးကြီးဆုံး: Element ရှိမှပဲ Switchery ကို ခေါ်ပါ
        if (elem !== null) {
            new Switchery(elem, { color: '#1ba4fd', size: 'small' });
        }
    });
    /* -- Bootstrap Popover -- */
